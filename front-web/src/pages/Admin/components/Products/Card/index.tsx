        ...
        <div className="card-base product-card-admin">
            <div className="row">
                ...
                <div className="col-3 pt-3 pr-5">
                    <Link to={`/admin/products/${product.id}`} key={product.id} className="btn btn-outline-secondary btn-block border-radius-10 mb-3">
                        EDITAR
                    </Link>
                    <button className="btn btn-outline-danger btn-block border-radius-10" onClick={() => onRemove(product.id)}>EXCLUIR</button>
                </div>
            </div>
